...
def get_registry():
    return Response(stream_with_context(json.dumps(_t.get_registry())), mimetype = 'application/json')
jsonschema.add_url_rule('/{}/registry'.format(_c.TYPE), view_func=get_registry, methods=[u'GET'])
